...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4PSDHCALDETECTOR_H
#define G4DETECTORS_PHG4PSDHCALDETECTOR_H
...
class PHG4PSDHcalDisplayAction;
class PHG4Subsystem;
class PHParameters;
...
class PHG4PSDHcalDetector : public PHG4Detector
{
 public:
  //! constructor
  PHG4PSDHcalDetector(PHG4Subsystem *subsys, PHCompositeNode *Node, PHParameters *parameters, const std::string &dnam);

  //! destructor
  virtual ~PHG4PSDHcalDetector() {}

  //! construct
  virtual void ConstructMe(G4LogicalVolume *world);

  //!@name volume accessors
  int IsInPSDHcal(G4VPhysicalVolume *) const;
 ...
 private:
  ...
  PHG4PSDHcalDisplayAction *m_DisplayAction = nullptr;

#include "PHG4PSDHcalSubsystem.h"

#include "PHG4PSDHcalDetector.h"
#include "PHG4PSDHcalDisplayAction.h"
#include "PHG4PSDHcalSteppingAction.h"
...
PHG4PSDHcalSubsystem::PHG4PSDHcalSubsystem(const std::string& name, const int lyr)
...
//_______________________________________________________________________
PHG4PSDHcalSubsystem::~PHG4PSDHcalSubsystem()
{
  delete m_DisplayAction;
}

//_______________________________________________________________________
int PHG4PSDHcalSubsystem::InitRunSubsystem(PHCompositeNode* topNode)
{
  PHNodeIterator iter(topNode);
  PHCompositeNode* dstNode = dynamic_cast<PHCompositeNode*>(iter.findFirst("PHCompositeNode", "DST"));

  // create display settings before detector
  m_DisplayAction = new PHG4PSDHcalDisplayAction(Name());
  // create detector
  m_Detector = new PHG4PSDHcalDetector(this, topNode, GetParams(), Name());
  ...
  if (GetParams()->get_int_param("active"))
  {
    ...
    m_SteppingAction = new PHG4PSDHcalSteppingAction(m_Detector, GetParams());
  }
...
//_______________________________________________________________________
int PHG4PSDHcalSubsystem::process_event(PHCompositeNode* topNode)
{
...
//_______________________________________________________________________
PHG4Detector* PHG4PSDHcalSubsystem::GetDetector() const
{
  return m_Detector;
}

void PHG4PSDHcalSubsystem::SetDefaultParameters()
{
  ...
  mappingfilename << "/PSDHcal/mapping/towerMap_PSDHCAL_2x.txt";
...
void PHG4PSDHcalSubsystem::SetTowerMappingFile(const std::string& filename)
{

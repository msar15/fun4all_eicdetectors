...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4PSDHCALSUBSYSTEM_H
#define G4DETECTORS_PHG4PSDHCALSUBSYSTEM_H
...
class PHG4PSDHcalSubsystem : public PHG4DetectorSubsystem
{
 public:
  /** Constructor
   */
  PHG4PSDHcalSubsystem(const std::string &name = "PSD_HCAL", const int layer = 0);

  /** Destructor
   */
  virtual ~PHG4PSDHcalSubsystem();
